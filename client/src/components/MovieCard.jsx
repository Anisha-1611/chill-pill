...
const MovieCard = ({movie}) => {
  ...
  return (
    <div className='flex flex-col justify-between p-3 bg-gray-800 rounded-2xl hover:-translate-y-1 tansition duration-300 w-66'>
      ...
      <p className='text-sm text-gray-400 mt-2 '>{new Date(movie.release_date).getFullYear()}&bull;{movie.genres.slice(0,2).map(genre => genre.name).join("|")}&bull;{timeFormat(movie.runtime)}
